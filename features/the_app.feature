Feature: The whole app
  ...
  Scenario: An unregistered user tries to text instalover
    When "1234567890" texts instalover with "hey!!!"
    Then "1234567890" should get a text "You must register first at instalover.com"

  @wip
  Scenario: Existing user tries to get some and is happy with everything
    When "8004688487" texts instalover with "new date"
    Then "8004688487" should get a text "How about Silvertone at 09:00PM? Reply 'ok' or 'new date'."

    When "8004688487" texts instalover with "ok"
    Then "1111111111" should get a text "Want to go on a date at Silvertone at 09:00PM? Reply 'accept' or ignore."
    And  "2222222222" should get a text "Want to go on a date at Silvertone at 09:00PM? Reply 'accept' or ignore."
    ...
    And "1111111111" should get a text "You got it! Meet at Silvertone at 09:00PM. Your date is: 'super hot'"
    And "8004688487" should get a text "You got it! Meet at Silvertone at 09:00PM. Your date is: 'red hair'"

  @later
  Scenario: Existing user asks for a date, but they're picky
    When "8004688487" texts instalover with "new date"
    Then "8004688487" should get a text "How about Silvertone at 09:00? Reply 'ok' or 'new date'."

    When "8004688487" texts instalover with "new date"
    Then "8004688487" should get a text "How about Mike's Apartment at 09:00? Reply 'ok' or 'new date'."
