(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["instalover"],              // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          $.each(tweets, function(i,item){
            ...
            list.append('<li>' + avatar + join + text + read_more + '</li>');
